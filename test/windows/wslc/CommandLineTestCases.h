...
// Anything that is not a keyword is compiled as a template, so only malformed template text fails.
COMMAND_LINE_TEST_CASE(L"system info --format literal", L"info", true)
COMMAND_LINE_TEST_CASE(L"system info --format {{.Id", L"info", false)
COMMAND_LINE_TEST_CASE(L"system info --notanarg", L"info", false)
COMMAND_LINE_TEST_CASE(L"system info extraarg", L"info", false)
COMMAND_LINE_TEST_CASE(L"info --format {{.Id", L"info", false)
...
COMMAND_LINE_TEST_CASE(L"container list --format {{.ID}}", L"list", true)
COMMAND_LINE_TEST_CASE(L"container list --format {{.ID", L"list", false)
...
COMMAND_LINE_TEST_CASE(L"image list --format {{.ID", L"list", false)
...
COMMAND_LINE_TEST_CASE(L"version --format {{.Client", L"version", false)
