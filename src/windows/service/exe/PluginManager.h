...
public:
    ...
    STDMETHODIMP WslcMountFolder(
        _In_ DWORD SessionId, _In_ LPCWSTR WindowsPath, _In_ BOOL ReadOnly, _In_ LPCWSTR Name, _Out_writes_(WSLC_MOUNTPOINT_LENGTH) CHAR* Mountpoint) override;
